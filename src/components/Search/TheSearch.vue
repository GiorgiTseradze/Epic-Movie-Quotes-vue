        ...
        <div v-if="search" class="absolute flex flex-col md:mx-auto lg:hidden w-full left-0 top-0 bg-[#11101A] h-[35rem] z-50">
            <div class="flex h-20 border-b-[0.06rem] border-[#40414A] w-full">
                ...
                <div class="flex mt-7 ml-2">
                    <Form>
                        <Field @keypress="submitSearch" v-model="value" class="w-60 ml-3 outline-none bg-inherit text-[#CED4DA] placeholder-white" name="search" placeholder="Search" />
                    </Form>
                </div>
            </div>
...
<script setup>
import { ref } from 'vue';
import { Field, Form, useFormValues } from 'vee-validate';
