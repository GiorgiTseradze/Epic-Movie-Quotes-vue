<template>
    <div class="flex flex-col items-center w-screen fixed  lg:w-[50rem]  lg:mt-20 bg-[#11101A]">
            ...
            <Form @submit="handleSubmit" class="flex flex-col w-[20rem] lg:w-[40rem]">
                ...
                <file-input/>
                    <div @click="handleChoose" class="flex cursor-pointer items-center h-16 mt-4 rounded bg-[#000000]">
                        ...
                        <img class="ml-6 lg:ml-12 w-4" src="@/assets/down-arrow.svg" />
                    </div>
                <div>
                        <Field v-model="movieId" name="movie_id" class="hidden bg-inherit text-white">
                        </Field>
                        <div @click="handleChoose" class="flex flex-col w-[40rem] bg-[#000000] h-[14rem] overflow-y-auto overflow-x-hidden rounded" v-if="chooseMovie">
